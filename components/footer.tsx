...
export default function Footer() {
  ...
  return (
    <footer className="py-16 bg-dark-black text-white relative overflow-hidden">
      <motion.div
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <Link href="/" className="text-4xl font-heading font-bold tracking-wider">
        ...
        >
          <p className="text-sm opacity-60 tracking-widest font-light">{translations[language].copyright}</p>
        </motion.div>
      </div>
    </footer>
  )
