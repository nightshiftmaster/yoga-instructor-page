  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        scrolled ? "bg-dark-black/95 backdrop-blur-sm shadow-md" : "bg-transparent",
      )}
    >
      <div className="container mx-auto flex justify-between items-center">
        <Link href="/" className="text-3xl font-heading font-bold tracking-wider text-teal">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {/* Desktop Navigation */}
        <motion.nav className="hidden md:flex space-x-10" variants={navVariants} initial="hidden" animate="visible">
          {["home", "about", "gallery", "courses", "contact"].map((item, index) => (
            <motion.button
              key={item}
